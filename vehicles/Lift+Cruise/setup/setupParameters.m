...
SimPar.Control.Alloc.Num_Mom            = 6; % Nominal number of allocation moments % im assuming this is the number of subsystems
SimPar.Control.Alloc.Num_Eff            = 9; % Nominal number of allocation effectors % is this correct
...
% Failure Types: 1=Hold Last, 2=Pre-Scale, 3=Post-Scale, 4=Pos Limits
% 5=Rate Limits, 6=Generic, 7=Runaway(currently inactive), 8=Control Reversal
SimPar.Fail.Props.FailInit           = [0; 0; 0; 0]; % Specify failure type (see above)
SimPar.Fail.Props.InitTime           = [0; 0; 0; 0]; % Specify failure start time (sim time)
SimPar.Fail.Props.StopTime           = [0; 0; 0; 0]; % Specify failure stop time (use inf for end of sim)
SimPar.Fail.Props.PreScale           = [0; 0; 0; 0]; % Specify decimal pre-scale factor (e.g. 0.10 or 1.3)
SimPar.Fail.Props.PostScale          = [0; 0; 0; 0]; % Specify decimal post-scale factor (e.g. 0.10 or 1.3)
