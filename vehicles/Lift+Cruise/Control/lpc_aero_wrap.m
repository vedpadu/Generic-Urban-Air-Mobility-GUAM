function [FM FM_x FM_u] = lpc_aero_wrap(model, x, u, rho)
  ...
  % model - model class
  % IMPORTANT
  % x - dynamic states [vb om] 
  % u needs to change to size of 9
  % u - control inputs [ delf dela dele delr omp1-5]
  % rho - air density 
...
% gulp which ones here
% ohh they just increment by 4 beeeetttt
idx_omp  = [ 7 11 15 19 23];
